...
import CdPlayerButton from "@/components/CdPlayerButton.vue";
import CdPlayerDisplay from "@/components/CdPlayerDisplay.vue";
  ...
  <main class="relative h-screen w-screen">
    ...
    <div class="relative z-10 flex h-full w-full flex-col items-center justify-center gap-5 px-4">
      ...
      <div class="flex max-w-full space-x-1">
        ...
        <CdPlayerButton label="Next track" :disabled="!canNext" @click="runCommand('next')">
          <NextIcon />
        </CdPlayerButton>
        <CdPlayerButton
          label="Pause"
